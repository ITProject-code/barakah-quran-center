...
import { 
  FaQuran, FaEnvelope, FaLock, FaChalkboardTeacher,
...
const TeacherLogin = () => {
  const [email, setEmail] = useState('teacher@barakah.com')
      ...
      >
        <div className="bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl p-8 md:p-10 border border-white/20">
          ...
          <div className="flex justify-between items-center mb-4">
            <Link to="/login" className="text-white/40 hover:text-white transition-colors text-sm flex items-center gap-1">
          ...
          <div className="text-center mb-8">
            ...
            >
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary-dark to-primary flex items-center justify-center shadow-2xl shadow-primary/30 border-4 border-gold/30 relative">
                <FaChalkboardTeacher className="text-4xl text-gold" />
                <motion.div
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="teacher@barakah.com"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-white/30 bg-white/5 text-gold focus:ring-gold focus:ring-offset-0" />
                <span className="ml-2 text-sm text-white/60">{t('Remember me', lang)}</span>
              </label>
